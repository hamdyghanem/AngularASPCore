...
import { ProductService } from '../../app/core/services/product-data.service';
...
describe('DefaultComponent', () => {
    ...
    let actionUrl: string = configuration.Server + 'api/products/';
    ...
    it('on init should get all products', async(
        inject([ProductService, MockBackend],
            (dataService: ProductService, backend: MockBackend) => {
                ...
                fixture.whenStable().then(() => {
                    ...
                    expect(JSON.stringify(comp.products)).toEqual(data);
                });
            })
    ));

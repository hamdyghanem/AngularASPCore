...
describe('DefaultComponent', function () {
    ...
    var actionUrl = configuration.Server + 'api/products/';
    var responses = {};
    ...
    it('on init should get all products', async(inject([ProductService, MockBackend], function (dataService, backend) {
